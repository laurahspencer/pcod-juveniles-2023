  ...
  pcas[[i]] <- print(ggscatter(tab.expr.annot,
    ...
    scale_color_manual(name="Temperature/Population", 
                       values=c("0"="black", "5"="gray25", "9"="gray50", "16"="gray90",
                                "Russia"="blue3", "Pervenets"="cornflowerblue",
                                "TanagaIsland"="darkseagreen", "AmchitkaPass"="darkseagreen1", 
                                "Unimak"="bisque", "Shumagins"="bisque3", 
                                "Kodiak"="darkorchid1", "HecateStrait"="darkviolet")) +
  ...
  pcas.genome[[i]] <- print(ggscatter(tab.expr.annot,
    ...
    scale_color_manual(name="Temperature/Population", 
                       values=c("0"="black", "5"="gray25", "9"="gray50", "16"="gray90",
                                ...
                                "TanagaIsland"="darkseagreen", "AmchitkaPass"="darkseagreen1", 
                                "Unimak"="bisque", "Shumagins"="bisque3", 
                                "Kodiak"="palevioletred1", "HecateStrait"="darkviolet")) +
      ggtitle(paste("PC", axes[i, "pc.x"], "x", "PC", axes[i, "pc.y"], sep="")))
}

pdf('../analysis-20230922/pca/pcas-genomewide.pdf')
pcas.genome
dev.off()
```
