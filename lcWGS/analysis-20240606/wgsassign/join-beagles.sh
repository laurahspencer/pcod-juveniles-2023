...
#SBATCH --output=/home/lspencer/pcod-lcwgs-2023/analysis-20240606/wgsassign/err-out/join-beagles.txt
...
mkdir ${base}/wgsassign/join-beagles-temp
temp=${base}/wgsassign/join-beagles-temp
...
beagle1=${base}/reference/gls_wgassign/pcod-refs_wholegenome_wgassign_filtered.beagle.gz
...
merged_beagle_name=wgsassign/refs-exp-merged
remove_temp_files="Yes" # if = "Yes" temporary files will be removed. Set to "No" (or anything else) to not remove them
remove_rehead_beagles="Yes" #if "Yes" the intermediate beagle files that contain all original GLs but include sample IDs will be removed. Set to "No" if you don't want this file.
