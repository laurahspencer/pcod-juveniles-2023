...
#SBATCH --job-name=plm_pcod-refs
#SBATCH --output=/home/lspencer/pcod-lcwgs-2023/analysis-20240606/reference/job_outfiles/pcod-refs_polymorphic_%A-%a.out
